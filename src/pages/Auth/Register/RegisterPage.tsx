        ...
        <div className={styles.authContainer}>
            <div className={styles.authCard}>
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <div className={styles.inputField}>
                            ...
                            <input
                                ...
                                required/>
                            <i
                                className={`fa-solid ${showConfirmPassword ? 'fa-eye' : 'fa-eye-slash'} ${styles.togglePass}`}
                    ...
                    <button id={styles.registerBtn} type="submit" className={styles.btn}>Đăng ký</button>
                    <p>Bạn đã có tài khoản? <Link className={styles.link} to="/login">Đăng nhập</Link></p>
                </form>
            </div>
        </div>
    )
