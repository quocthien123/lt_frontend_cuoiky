...
function CategoryPage() {
    ...
    const handleLikeClick = () => {
        ...
        if (slug) {
            ...
            setIsLiked(liked);
            toast.success(liked ? "Đã thêm vào mục yêu thích!" : "Đã gỡ khỏi mục yêu thích!");
        }
    }
    ...
    return (
        <div>
            <MainLayout>
                ...
                <div className={styles.action_bar} style={{
                    display: 'flex',
                    gap: '12px',
                    marginBottom: '20px',
                    alignItems: 'center'
                    ...
                    <div className={styles.speak_news}>
                        ...
                        >
                            ...
                            <span style={{fontWeight: '500'}}>{isLiked ? 'Đã lưu' : 'Lưu tin'}</span>
                        </button>
                    </div>
